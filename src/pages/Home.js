...
import './Home.css'
import { homeMovieApi } from '../service/allApis'
        ...
        <div>
            <Row className='pt-5 pb-5'>
                <Col className='text-center p-5'>
                    ...
                    <Link to={'/dashboard'} style={{ textDecoration: 'none' }}>
                        ...
                        <Button variant="primary">Register/Login</Button></Link>
}
                </Col>
            ...
            <div className='m-2 p-5'>
                ...
                <Row>
                    ...
                    {homeMovies.length > 0 ? homeMovies.map(i => (
                        <Col key={i} lg={4} md={6} sm={12} className="mb-3">
                            <Link to={`/seat/${i._id}`} style={{ textDecoration: 'none' }}>
                                <MovieCard movie={i}></MovieCard>
                            </Link>
                        </Col>
